...
class TestPwnDocMCPServer:
    ...
    def config(self):
        ...
        return Config(url="https://pwndoc.test.com", token="test-jwt-token")
    ...
    async def test_handle_call_tool_create_audit(self, server):
        ...
        with patch.object(server.client, "create_audit") as mock_create:
            ...
            result = await server.handle_call_tool(
                "create_audit",
                {"name": "New Audit", "audit_type": "Web Application", "language": "en"},
            )
    ...
    async def test_handle_call_tool_with_filter(self, server, mock_audit):
        ...
        with patch.object(server.client, "list_audits") as mock_list:
            ...
            result = await server.handle_call_tool(
                "list_audits", {"finding_title": "SQL Injection"}
            )
...
class TestCreateServer:
    ...
    def test_create_server_with_config(self):
        ...
        config = Config(url="https://pwndoc.test.com", token="test-token")
    ...
    def test_create_server_with_kwargs(self):
        ...
        server = create_server(url="https://pwndoc.test.com", token="test-token")
...
class TestServerTransports:
    ...
    def config(self):
        """Create test configuration."""
        return Config(url="https://pwndoc.test.com", token="test-token")
